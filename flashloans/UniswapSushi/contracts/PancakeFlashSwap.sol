...
contract UniswapFlashSwap {
    ...
    // Check profitablility
    // Check whether output > input
    ...
    function uniswapV2Call(
        ...
        (address tokenBorrow, uint256 amount, address _myAddress) = abi.decode(
            _data,
        ...
        // Place Trades
        uint256 trade1AcquireCoin = placeTrade(
            USDC,
            LINK,
            loanAmount,
            UNISWAP_FACTORY,
        ...
        uint256 trade2AcquireCoin = placeTrade(
            LINK,
            USDC,
            trade1AcquireCoin,
            SUSHI_FACTORY,
        ...
        // Check profitablility
        bool profCheck = checkProfitability(loanAmount, trade2AcquireCoin);
        require(profCheck, "Arb not profitable");

        // Pay myself
        IERC20 otherToken = IERC20(USDC);
        otherToken.transfer(_myAddress, trade2AcquireCoin - amountToRepay);
        console.log(_myAddress);
        // Pay back the loan
